    ...
    */
    ...
    'connections' => [
        ...
        'mysql_tertiary' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_TERTIARY_HOST', '127.0.0.1'),
            'port' => env('DB_TERTIARY_PORT', '3306'),
            'database' => env('DB_TERTIARY_DATABASE', 'forge'),
            'username' => env('DB_TERTIARY_USERNAME', 'forge'),
            'password' => env('DB_TERTIARY_PASSWORD', ''),
            'unix_socket' => env('DB_TERTIARY_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
